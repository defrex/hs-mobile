...
test('consy.frame.form.fields.Field', function(){
    var Field = consy.frame.form.fields.Field;
...
test('consy.frame.form.fields.TextField', function(){
    var TextField = consy.frame.form.fields.TextField;
...
test('consy.frame.Form', function(){
    var Form = consy.frame.Form,
        TextField = consy.frame.form.fields.TextField;
    ...
    goog.inherits(MyForm, consy.frame.Form);
